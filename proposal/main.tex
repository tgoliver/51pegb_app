...
%Estimates for Europa suggest $Bi \sim O\lb 10^{6}\rb$\citep{dL23} which is not numerically feasible. Therefore, I propose to simulate at two different values of $D_{i}$ to determine scaling behavior with $Bi$ to extrapolate to the icy moons. 
...
%Otherwise, it will not be possible to generate the models needed to translate observations into statements about the underlying convection.
