...
\usepackage[backend=biber,style=numeric,maxnames =4,giveninits = true]{biblatex}
...
%A specific application is to serve the \textit{Europa Clipper} and \textit{JUICE} space missions by providing insight for relating upcoming data to underlying ocean dynamics and its coupling with the ice crust.
...
\begin{figure}
	\begin{center}
		\subfloat[][]{\includegraphics[width=0.35\textwidth]{figures/cht}}
	\subfloat[][]{\includegraphics[width=0.35\textwidth]{figures/cht_plane}}
	\end{center}
